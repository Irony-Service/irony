...
export default function LayoutClient() {
  ...
  return (
    <div className="sticky bottom-0 left-0 w-full h-12 flex bg-gray-100">
      <div className={`w-1/2 h-full rounded-tl-2xl ${pathname === links[0].href ? "bg-gray-800" : "bg-white"}`}>
      ...
      <div className={`w-1/2 h-full rounded-tr-2xl ${pathname === links[1].href ? "bg-gray-800" : "bg-white"}`}>
