      ...
      >
        <div className="w-[80%] flex justify-between items-center">
          <div className="flex items-center gap-1">
            <Image src={`/service/carbon_delivery-${props.order?.delivery_type?.includes("pickup") ? "add" : "minus"}.svg`} alt="Login" width={18} height={18} />
        ...
        <Link href={props.order?.maps_link || ""} className="p-[6px] rounded-full bg-amber-300">
          <Image src="/service/maps_arrow.svg" alt="Login" width={16} height={16} />
        </Link>
